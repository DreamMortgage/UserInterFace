...
<title>Securitization - Purchased Mortgages</title>
</head>
<body>
<div class="container">
...
<div class="sidebar">
  <ul>
    ...
    <li><a href="securitization?action=getPurchased" class="sideActive">Purchased Mortgages</a></li>   
  </ul>
</div>

<p id="successMsg">${successMsg}</p> 
<p id="errorMsg">${errorMsg}</p>
<p id="desc" style="font-weight: bold; color: green;">On this page GSE views its portfolio of purchased mortgages.</p>
