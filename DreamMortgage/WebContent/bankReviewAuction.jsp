	...
	$("#discountPercentage").blur(function(){
		...
		$('#closeAuction').click(function(e) {
			...
			if(!isAtleastOneChecked){
				...
				$('#form').hide();
				document.getElementById('loading').style.display='block';
			$('#bankForm').attr("action","bank?action=closeAuction&type=auction");
			return true;
			}
...
<div class="sidebar">
  <ul>
    ...
    <li><a href="bank?action=reviewAuction" class="sideActive">Review Auction Mortgages</a></li> 
...
<p id="desc" style="font-weight: bold; color: green;">On this page lending bank has option to retain unsold mortgage deeds.</p>
<div style="margin-left: 600px;"><img id="loading" src="loading.gif" style="display: none; height: 150px; width: 150px; " /></div>

<article>
<div id="form">
<p id="head"></p> 
<c:if test="${not empty reviewAuctionCustomerList}">
...
<c:forEach items="${reviewAuctionCustomerList}" var="eachCustomer">
...
<input type="submit" id="closeAuction" value="Close Auction">
