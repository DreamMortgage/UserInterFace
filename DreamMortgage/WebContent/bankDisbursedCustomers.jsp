...
<p id="desc" style="font-weight: bold; color: green;">This page displays all the mortgages in disbursed stage</p>
...
<form action="bank?action=get&type=monthlyservice" method="POST"> 
<label style="font-weight: bold">Select a Mortgage :</label>
