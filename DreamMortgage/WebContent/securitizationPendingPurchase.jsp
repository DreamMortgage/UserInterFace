...
<title>Securitization - Pending Purchases</title>
</head>
<body>
<div class="container">
...
<div class="sidebar">
  <ul>
		<li><a href="securitization?action=get">Request Purchase of Conformed Mortgages</a></li>
    <li><a href="securitization?action=getPending"  class="sideActive">View Pending Purchase request</a></li>  
...
<p id="desc" style="font-weight: bold; color: green;">On this page GSE can view all its purchase request pending with lending bank.</p>
<div style="margin-left: 600px;"><img id="loading" src="loading.gif" style="display: none; height: 150px; width: 150px; " /></div>

<article>

<div id="form">
 <c:if test="${not empty pendingPurchaseCustomerList}">
 <h2>Pending Mortgages</h2>
...
<c:forEach items="${pendingPurchaseCustomerList}" var="eachCustomer">
