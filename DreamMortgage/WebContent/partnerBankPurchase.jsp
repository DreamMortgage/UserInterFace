...
<title>Partner Bank - Purchase</title>
</head>
<body>
<div class="container">
...
<div class="sidebar">
  <ul>
		<li><a href="partnerbank?action=getPurchase" class="sideActive">Purchase Mortgages</a></li>
    <li><a href="partnerbank?action=viewPurchased">View Purchased Mortgages</a></li>  
  </ul>
</div>
...
<p id="desc" style="font-weight: bold; color: green;">On this page partner bank purchases the available auction mortgages.</p>
<div style="margin-left: 600px;"><img id="loading" src="loading.gif" style="display: none; height: 150px; width: 150px; " /></div>

<article>
<div id="form">
<c:if test="${not empty getCustomerList}">

<p id="head"></p> 
<h2>Purchase Mortgage</h2>
<form action="partnerbank?action=requestPurchase" method="POST">
...
<c:forEach items="${getCustomerList}" var="eachCustomer">
...
<br/>
<input type="submit" id="submit" value="Request Purchase" style="width: 120px; height:27px;">
